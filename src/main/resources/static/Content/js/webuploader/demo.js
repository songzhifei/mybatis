jQuery(function () {
    ...
    uploader = WebUploader.create({
        ...
        swf: BASE_URL + '/Content/webuploader/Uploader.swf',// swf文件路径
    ...
    uploader.onError = function (code) {
        var message = '';
        switch (code) {
            case 'Q_TYPE_DENIED': message = "文件格式不正确或文件大小为0"; break;
            case 'Q_EXCEED_NUM_LIMIT': message = "添加的文件数量超出了限制"; break;
            case 'Q_EXCEED_SIZE_LIMIT': message = "添加的文件总大小超出了限制"; break;
            case 'F_EXCEED_SIZE': message = "添加的文件大小超出了限制"; break;
        }
        alert(message);
        console.log(code);
        //alert('Eroor: ' + code);
